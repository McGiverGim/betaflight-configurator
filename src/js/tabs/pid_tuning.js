...
TABS.pid_tuning.initialize = function (callback) {
    ...
    function pid_and_rc_to_form() {
        ...
        if (semver.gte(FC.CONFIG.apiVersion, "1.42.0")) {
            ...
            $('.pid_filter input[name="dynamicNotchWidthPercent"]').val(FC.FILTER_CONFIG.dyn_notch_width_percent);
            $('.pid_filter input[name="dynamicNotchQ"]').val(FC.FILTER_CONFIG.dyn_notch_q);
