...
const FC = {
    ...
    resetState: function () {
        ...
        this.PID_names =                [];
        this.PIDS_ACTIVE = new Array(10);
        this.PIDs = new Array(10);
        for (var i = 0; i < 10; i++) {
            this.PIDS_ACTIVE[i] = new Array(3);
            this.PIDs[i] = new Array(3);
        }
    ...
    getFilterDefaults: function() {
        var versionFilterDefaults = this.DEFAULT;
    ...
    getPidDefaults: function() {
        var versionPidDefaults = this.DEFAULT_PIDS;
